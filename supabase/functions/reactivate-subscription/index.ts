...
// Reactiva una suscripción programada para cancelarse (cancel_at_period_end: false).
// Solo funciona si la suscripción todavía está en periodo de gracia (no ha vencido).
